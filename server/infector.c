/***[ThuNderSoft]*************************************************************
                INFECTOR: program za inficiranje određenog fajla
                                   ver: 0.12
                                     WEIRD
*****************************************************************************/

/* HISTORY */
// ver 0.12 (18-may-1999): dodata obaveštenja o greškama
...
LRESULT CALLBACK InfLoop (HWND hd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    switch (msg) {
        ...
        case WM_INITDIALOG: // inicijalizacija dialoga PRE nego što se dijalog otvori
            ...
            SetDlgItemText(hDlg, ID_INFO, &eporuka[1]);     // ispiši poruku
            SendDlgItemMessage(hDlg, ID_EDIT1, EM_SETLIMITTEXT, MAX_PATH, 0);   // ograniči edit box sadržaj
            SendDlgItemMessage(hDlg, ID_EDIT2, EM_SETLIMITTEXT, MAX_PATH, 0);   // ograniči edit box sadržaj
